...
public class JzvdStd extends Jzvd {
    ...
    public void isTopContaintShow(boolean isShow) {
        this.isShow = isShow;
    }
    ...
    protected void clickClarity() {
        ...
        OnClickListener mQualityListener = new OnClickListener() {
            ...
            public void onClick(View v1) {
                ...
                JzvdStd.this.changeUrl(jzDataSource, JzvdStd.this.getCurrentPositionWhenPlaying());
    ...
    public void setSystemTimeAndBattery() {
        ...
        if ((System.currentTimeMillis() - LAST_GET_BATTERYLEVEL_TIME) > 30000) {
            ...
            jzvdContext.registerReceiver(battertReceiver, new IntentFilter(Intent.ACTION_BATTERY_CHANGED));
        } else {
            setBatteryLevel();
        }
    }
