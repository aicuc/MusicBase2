...
import com.musicbase.util.UriUtils;
...
public class MipcaActivityCapture extends BaseActivity implements Callback {
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            OkGo.<String>post(Preferences.ADDBOOK_URL).tag(this).params("userId", SPUtility.getUserId(this) + "").params("qrcodeName", resultString).params("AppInfo", appInfo).execute(new StringCallback() {
                @Override
                public void onSuccess(Response<String> response) {
                    ...
                    if (bean != null && bean.getCode().equals("SUCCESS")) {
                        ActivityUtils.showToast(MipcaActivityCapture.this, bean.getCodeInfo());
                        MipcaActivityCapture.this.setResult(RESULT_OK);
                        finish();
                    } else {
                        ActivityUtils.showToast(MipcaActivityCapture.this, "添加书籍失败," + bean.getCodeInfo());
                        finish();
                    }
                }
                ...
                public void onError(Response<String> response) {
                    ActivityUtils.showToast(MipcaActivityCapture.this, "加载失败,请检查网络!");
                    dismissMyDialog();
                }
