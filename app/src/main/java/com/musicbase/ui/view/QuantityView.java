...
public class QuantityView extends LinearLayout implements View.OnClickListener {
    ...
    private int quantity=1, maxQuantity, minQuantity=1;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        quantityPadding = (int) a.getDimension(R.styleable.QuantityView_qv_quantityPadding, pxFromDp(12));
        ...
        mButtonAdd.setTextSize(24);
        mButtonAdd.setStateListAnimator(null);
        ...
        mButtonRemove.setTextSize(24);
        mButtonRemove.setStateListAnimator(null);
