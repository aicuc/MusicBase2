...
public class SPUtility {
    ...
    public static final int getUserId(Context c) {
        return PreferenceManager.getDefaultSharedPreferences(c).getInt("userid", 0);
    }
    ...
    public static final boolean getSPBoolean(Context c, int keyId, boolean defaultValue) {
        return PreferenceManager.getDefaultSharedPreferences(c).getBoolean(c.getResources().getString(keyId), defaultValue);
    }
    ...
    public static final boolean getSPBoolean(Context c, String key, boolean defaultValue) {
    ...
    public static final int getSPInteger(Context c, int keyId) {
        return PreferenceManager.getDefaultSharedPreferences(c).getInt(c.getResources().getString(keyId), -1);
    }
    ...
    public static final String getSPString(Context c, int keyId) {
        if (c != null)
            return PreferenceManager.getDefaultSharedPreferences(c).getString(c.getResources().getString(keyId), "");
        else
            return "";
    }
